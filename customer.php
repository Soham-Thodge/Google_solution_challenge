      ...
      <div class="container">
        ...
        <div class="form-check mt-5">
          <p>
            ...
            <input class="pwd" name="Password" type="password" class="form-control mt-2" id="exampleInputPassword1"
        ...
        <div class="form-check mt-5">
          <p>
            ...
            <input class="connumber" name="Phone_number" type="number" class="form-control mt-2" id="Contactnumber"
